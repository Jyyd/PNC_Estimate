...
monthFlag = 1; % if season 0, month 1
        ...
        pattern = '_(\w+)\.mat'; 
                ...
                if ~isempty(match1) && ~isempty(match2)
                    ...
                    if strcmp(lastPart1, 'month1') && strcmp(lastPart2, 'month2')
                        text(5.7, 47.78, '(a) Feb. minus Jan.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                    ...
                    elseif strcmp(lastPart1, 'month2') && strcmp(lastPart2, 'month3')
                        text(5.7, 47.78, '(b) Mar. minus Feb.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    elseif strcmp(lastPart1, 'month3') && strcmp(lastPart2, 'month4')
                        text(5.7, 47.78, '(c) Apr. minus Mar.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    elseif strcmp(lastPart1, 'month4') && strcmp(lastPart2, 'month5')
                        text(5.7, 47.78, '(d) May. minus Apr.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    elseif strcmp(lastPart1, 'month5') && strcmp(lastPart2, 'month6')
                        text(5.7, 47.78, '(e) Jun. minus May.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    elseif strcmp(lastPart1, 'month6') && strcmp(lastPart2, 'month7')
                        text(5.7, 47.78, '(f) Jul. minus Jun.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    elseif strcmp(lastPart1, 'month7') && strcmp(lastPart2, 'month8')
                        text(5.7, 47.78, '(g) Aug. minus Jul.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    elseif strcmp(lastPart1, 'month8') && strcmp(lastPart2, 'month9')
                        text(5.7, 47.78, '(h) Sep. minus Aug.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    elseif strcmp(lastPart1, 'month9') && strcmp(lastPart2, 'month10')
                        text(5.7, 47.78, '(i) Oct. minus Sep.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    elseif strcmp(lastPart1, 'month10') && strcmp(lastPart2, 'month11')
                        text(5.7, 47.78, '(j) Nov. minus Oct.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    elseif strcmp(lastPart1, 'month11') && strcmp(lastPart2, 'month12')
                        text(5.7, 47.78, '(k) Dec. minus Nov.', 'FontSize', 24, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top', 'FontAngle', 'italic')
                    else
            ...
            if i <= length(matFiles) && j <= length(matFiles)
                ...
                if ~isempty(match1) && ~isempty(match2)
                    ...
                    if strcmp(lastPart1, 'part0') && strcmp(lastPart2, 'part1')
                        text(5.7, 47.78, '(a) AMJ minus JFM', 'FontSize', 26, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top')
                    elseif strcmp(lastPart1, 'part1') && strcmp(lastPart2, 'part2')
                        text(5.7, 47.78, '(b) JAS minus AMJ', 'FontSize', 26, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top')
                    elseif strcmp(lastPart1, 'part2') && strcmp(lastPart2, 'part3')
                        text(5.7, 47.78, '(c) OND minus JAS', 'FontSize', 26, 'FontName', 'Arial', 'Color', ... 
                                'black', 'HorizontalAlignment', 'left', 'VerticalAlignment', 'top')
                    else
