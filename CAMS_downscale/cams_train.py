'''
Author: JYYD
Date: 2023-09-20 00:41:57
LastEditors: Jyyd 78450036+Jyyd@users.noreply.github.com
LastEditTime: 2024-01-02 14:40:07
FilePath: \code\finalcode\cams_train.py
'''
...
def get_matdata(pollution:str='NOX',  model_name:str='RandomForest'):
    ...
    avgConc = {
        'lonNew': np.array(lonNew),  # 经度值
        'latNew': np.array(latNew),  # 纬度值
        'avgConc': np.array(value),   # NOX值
    }
    year = 2020
